/*Code adapted from Arduino Code found at https://github.com/bluerobotics/BlueRobotics_MS5837_Library/blob/master/MS5837.cpp */
...
#ifdef HAL_AIRSPEED_MS5837_I2C_BUS
#define MS5837_I2C_BUS HAL_AIRSPEED_MS5837_I2C_BUS
#else
#define MS5827_I2C_BUS 1
#endif
...
bool MS5837::init() {
	...
	AP_HAL_PX4::I2CDriver::write(MS5837_ADDR, 8, MS537_RESET);

	// Wait for reset to complete
	delay(10);

	/*Code taken from Arduino, will do without for now
